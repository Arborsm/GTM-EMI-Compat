...
public final class GTMEMICompatEmiPlugin implements EmiPlugin {
    ...
    public void register(EmiRegistry registry) {
        ...
        for (GTRecipe gtRecipe : registry.getRecipeManager().getAllRecipesFor(GTRecipeTypes.COMPRESSOR_RECIPES)) {
            registry.addRecipe(new GTCompressorEmiRecipe(gtRecipe));
        }
    }
}
